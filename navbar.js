...
function showRegions() {
      ...
      desktopMenu.innerHTML = uniqueRegions.map(region => `
        <a href="https://country-explorer-by-atilla.vercel.app/regions.html?id=${region}" class="px-3 py-2 text-yellow-500 hover:text-indigo-300 hover:underline transition duration-300">${region}</a>
      `).join("")
